    ...
    public void insertFill(MetaObject metaObject) {
        ...
        if (metaObject.hasGetter(createTime)) {
            ...
            if (metaObject.getValue(createTime) == null) {
                ...
                this.strictInsertFill(metaObject, createTime, String.class, LocalDateTime.now().format(fmt));
            }
        }
        ...
        if (metaObject.hasGetter(updateTime)) {
            ...
            if (metaObject.getValue(updateTime) == null) {
                //如果值是null，再进行填充，否则可能是用户自己在代码里set值了
                this.strictInsertFill(metaObject, updateTime, String.class, LocalDateTime.now().format(fmt));
            }
        }
